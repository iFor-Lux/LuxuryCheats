...
object ThemeManager {
     ...
     */
    fun isDynamicColorAvailable(): Boolean = android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S
...
private val DarkColorScheme =
    darkColorScheme(
        ...
        // 202020 - Requested for Login Screen background
        surfaceVariant = PremiumGray,
        // White - Requested for Login text
        onSurfaceVariant = CleanWhite,
        // 404040 - Requested for Login input backgrounds
        surfaceContainer = Gray40,
        // 777777 - Requested for Login Screen border
        outline = MediumGray77,
...
private val LightColorScheme =
    lightColorScheme(
        ...
        onTertiaryContainer = CleanWhite,
        // Un fondo casi blanco pero que permite ver tarjetas blancas
        background = Color(0xFFF8F8F8),
        onBackground = OnyxBlack,
        // Tarjetas pueden ser blancas sobre el fondo grisáceo
        surface = CleanWhite,
        onSurface = OnyxBlack,
        // Gris para tarjetas secundarias
        surfaceVariant = Color(0xFFEDEDED),
        onSurfaceVariant = OnyxBlack,
        // Gris más oscuro para inputs
        surfaceContainer = Color(0xFFD8D8D8),
